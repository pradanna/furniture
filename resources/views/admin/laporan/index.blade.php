@extends('layouts.app', ['title' => 'Laporan Transaksi - Admin'])
        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="flex items-center">
                ...
                <button class="text-white ml-4 focus:outline-none bg-green-600 px-4 py-2 shadow-sm rounded-md">
                    <a href="{{ route('export_transaksi') }}">Cetak Laporan</a>
                </button>
                    ...
                    <table class="min-w-full table-auto">
                        <thead class="justify-between">
                            <tr class="bg-gray-600 w-full">
                                ...
                                <th class="px-16 py-2">
                                    <span class="text-white">Total Item</span>
                                </th>
                                <th class="px-16 py-2">
                        ...
                        <tbody class="bg-gray-200">
                            @forelse($transactions as $t)
                                <tr class="border bg-white">
                                    ...
                                    <td class="px-16 py-2">
                                        {{ moneyFormat($t->total_transfer) }}
                                    </td>
                                    <td class="px-16 py-2">
                                        {{ $t->total_item }}
                                    </td>
                                    <td class="px-16 py-2">
                                        {{moneyFormat($t->total_harga) }}
                                    </td>
