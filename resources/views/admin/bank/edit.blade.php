@extends('layouts.app', ['title' => 'Edit Bank - Admin'])
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="p-6 bg-white rounded-md shadow-md">
                <h2 class="text-lg text-gray-700 font-semibold capitalize">Edit Bank</h2>
                <hr class="mt-4">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                                name="name" value="{{ old('name', $bank->name) }}">
                            @error('name')
                                <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
                                        <p class="text-gray-600 text-sm">{{ $message }}</p>
                        ...
                        <div>
                            {{-- NamaProduk --}}
                            <label class="text-gray-700" for="nomor_rekening">Nomor Rekening</label>
                            <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                                name="nomor_rekening" value="{{ old('nomor_rekening', $bank->nomor_rekening) }}">
                        ...
                        <div>
                            {{-- NamaProduk --}}
                            <label class="text-gray-700" for="card_name">Atas Nama</label>
                            <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                                name="card_name" value="{{ old('card_name', $bank->card_name) }}">
                            @error('card_name')
                                <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
                                        <p class="text-gray-600 text-sm">{{ $message }}</p>
