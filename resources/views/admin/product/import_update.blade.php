@extends('layouts.app', ['title' => 'Update Produk - Admin'])
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="p-6 bg-white rounded-md shadow-md">
                <h2 class="text-lg text-gray-700 font-semibold capitalize">Update Data Produk</h2>
                <hr class="mt-4">
                <form action="{{ route('imported') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
