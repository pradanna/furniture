@extends('layouts.app', ['title' => 'Slide - Admin'])
        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="flex items-center">
                <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                    <a href="{{ route('admin.slide.create') }}">Tambah</a>
                </button>
                ...
                <div class="inline-block min-w-full shadow-sm rounded-lg overflow-hidden">
                        ...
                        <tbody class="bg-gray-200">
                            @forelse($slide as $s)
                                <tr class="border bg-white">
                                    ...
                                    <td class="px-5 py-2">
                                        <img class=" object-cover" width="64" height="64" src="{{ $s->image }}">
                                    </td>

                                    <td class="px-10 py-2 text-center">
                                        <a href="{{ route('admin.slide.edit', $s->id) }}"
                    ...
                    @if ($slide->hasPages())
                        <div class="bg-white p-3">
                            {{ $slide->links('vendor.pagination.tailwind') }}
                        </div>
                    @endif
                </div>
            </div>
